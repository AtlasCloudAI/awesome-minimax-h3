...
**条目怎么读。** 每条都带热度与最后更新时间，均为 2026-08-18 从官方 API 实测读取。`⭐` 表示这个社区项目被 MiniMax 官方点过名（开源一周盘点或社区精选页）——所以「官方」那一节里不标，那节本来就整节都是官方的。
...
- [MiniMax-AI/MiniMax-H3](https://github.com/MiniMax-AI/MiniMax-H3) `6.2k★ · 2026-08-15` — 官方仓库——推理代码、模型卡与各任务参考管线。
- [MiniMaxAI/MiniMax-H3](https://huggingface.co/MiniMaxAI/MiniMax-H3) `4.1k♥ · 2.4M↓ · 2026-08-13` — Hugging Face 官方权重。
...
- ⭐ [antirez/h3.c](https://github.com/antirez/h3.c) `2.2k★ · 2026-08-11` — Redis 作者 antirez 用 C + Metal 从零重写的 Apple Silicon 原生推理引擎：直读 safetensors，Qwen 文/视编码器 + DiT + 双 VAE 全装进一个原生 Mac 程序，不依赖 Python/PyTorch。支持文生音视频、首尾帧与 Ref2VA。
...
- ⭐ [charlie12345/R9700AIProComfyUIPatch](https://github.com/charlie12345/R9700AIProComfyUIPatch) `10★ · 2026-08-08` — 面向 RDNA4 Radeon AI PRO R9700 + ROCm 的 ComfyUI 补丁：优化 partial RoPE、长序列注意力与模型加载。在 32GB R9700 上按 864×480 / 124 帧 / 20 步实测提速。

### 在线试玩

- ⭐ [MiniMaxAI/MiniMax-H3-Turbo-Lora](https://huggingface.co/spaces/MiniMaxAI/MiniMax-H3-Turbo-Lora) `201♥ · 2026-08-14` — 官方 Space，跑 Turbo LoRA。
- [multimodalart/minimax-h3](https://huggingface.co/spaces/multimodalart/minimax-h3) `261♥ · 2026-08-16` — 社区 likes 最高的 Space。
- [mrfakename/minimax-h3-ultra-fast](https://huggingface.co/spaces/mrfakename/minimax-h3-ultra-fast) `111♥ · 2026-08-08` — 少步数版本，适合快速尝鲜。
- [multimodalart/minimax-h3-reference](https://huggingface.co/spaces/multimodalart/minimax-h3-reference) `82♥ · 2026-08-16` — 在浏览器里试参考条件（Ref2VA）模式。
- [akhaliq/MiniMax-H3-Turbo-Lora](https://huggingface.co/spaces/akhaliq/MiniMax-H3-Turbo-Lora) `62♥ · 2026-08-12` — 另一个托管的 Turbo LoRA demo。
- [geocine/MiniMax-H3-Prompt-Enhancer](https://huggingface.co/spaces/geocine/MiniMax-H3-Prompt-Enhancer) `21♥ · 2026-08-09` — 把粗略想法扩写成适配 H3 的提示词。
...
- ⭐ [Comfy-Org/MiniMax-H3](https://huggingface.co/Comfy-Org/MiniMax-H3) `1.4k♥ · 14M↓ · 2026-08-17` — ComfyUI 官方打包版，按下载量看多数人实际就是这样跑 H3 的：裁掉 4 成调制权重 + INT8 ConvRot + 定制 kernel，123.6GB → 42.5GB。
- [DeepBeepMeep/MiniMax-H3](https://huggingface.co/DeepBeepMeep/MiniMax-H3) `49♥ · 371.6k↓ · 2026-08-13` — Wan2GP 作者的低显存打包。

### 量化

- [realrebelai/MiniMax-H3_GGUFs](https://huggingface.co/realrebelai/MiniMax-H3_GGUFs) *(GGUF)* `201♥ · 392.5k↓ · 2026-08-08` — likes 最高的 GGUF 合集。
- [Abiray/Minimax-H3-nvfp4-INT4-INT8-Convrot](https://huggingface.co/Abiray/Minimax-H3-nvfp4-INT4-INT8-Convrot) *(NVFP4 · INT4/INT8 ConvRot)* `193♥ · 703.4k↓ · 2026-08-15` — 混合精度构建；社区量化里下载量最高。
- [unsloth/MiniMax-H3-GGUF](https://huggingface.co/unsloth/MiniMax-H3-GGUF) *(GGUF)* `186♥ · 217.9k↓ · 2026-08-14` — Unsloth 出品的 GGUF 转换。
- [Abiray/MiniMax-H3-GGUF](https://huggingface.co/Abiray/MiniMax-H3-GGUF) *(GGUF)* `113♥ · 723.4k↓ · 2026-08-08` — 使用面很广的 GGUF 合集。
...
- [Kijai/MiniMax-H3_comfy](https://huggingface.co/Kijai/MiniMax-H3_comfy) `372♥ · 2026-08-13` — Kijai 的 ComfyUI 转换合集——事实标准组件集，含降 rank 的 LoRA。
- [Kijai/MiniMax-H3-experimental](https://huggingface.co/Kijai/MiniMax-H3-experimental) `236♥ · 2026-08-08` — 同作者的实验版本。
- [Kijai/MiniMax-H3-TAE](https://huggingface.co/Kijai/MiniMax-H3-TAE) `139♥ · 2026-08-05` — 微型自编码器——用快速预览替代整段 VAE 解码。
...
- [drbaph/MiniMax-H3-Turbo-Lora-ComfyUI](https://huggingface.co/drbaph/MiniMax-H3-Turbo-Lora-ComfyUI) `335♥ · 141.4k↓ · 2026-08-13` — 为 pruned 构建做的兼容转换。
...
- [Abiray/MiniMax-H3-Turbo-Lora-Pruned-ComfyUI](https://huggingface.co/Abiray/MiniMax-H3-Turbo-Lora-Pruned-ComfyUI) `43♥ · 15.9k↓ · 2026-08-09` — 附带工作流 JSON。
...
- [kijai/ComfyUI-SolAttn_triton](https://github.com/kijai/ComfyUI-SolAttn_triton) `323★ · 2026-08-08` — 用 Triton 把 Sol-Attn 落到 ComfyUI。
- [Saganaki22/ComfyUI-sol-attn](https://github.com/Saganaki22/ComfyUI-sol-attn) `93★ · 2026-08-13` — 另一个 Sol-Attn 集成。
- [xmarre/ComfyUI-Spectrum-MiniMax-H3](https://github.com/xmarre/ComfyUI-Spectrum-MiniMax-H3) `530★ · 2026-08-16` — 频谱预测加速。
- [HELPMEEADICE/TE-Speed-MiniMaxH3-OSS](https://github.com/HELPMEEADICE/TE-Speed-MiniMaxH3-OSS) `251★ · 2026-08-03` — 文本编码器超级缓存加速。
...
- ⭐ [IAmIronMan42/MiniMax-H3-FineTuning](https://github.com/IAmIronMan42/MiniMax-H3-FineTuning) `55★ · 2026-08-10` — 基于官方 diffusers 集成的完整微调：画面与声音分别处理噪声日程，真实立体声入训。已在 8×A800 上用 2000+ 条 30s / 448×768 素材跑通。
- [modelscope/DiffSynth-Studio](https://github.com/modelscope/DiffSynth-Studio) `13k★ · 2026-08-17` — H3 完整训练链路——LoRA 训练脚本 + 模型文档。
...
- [ostris/ai-toolkit](https://github.com/ostris/ai-toolkit) `11.7k★ · 2026-08-17` — 已加入 H3 t2v / i2v 训练。
- [unslothai/unsloth](https://github.com/unslothai/unsloth) `73.3k★ · 2026-08-18` — 支持的训练目标中明确列出 MiniMax-H3。
...
- [T8mars/comfyui-minimax-h3-audio-T8](https://github.com/T8mars/comfyui-minimax-h3-audio-T8) `729★ · 2026-08-17` — 音频侧节点——多数 H3 工作流最没用起来的一块。
- [ethanfel/ComfyUI-MiniMax-H3-Guide](https://github.com/ethanfel/ComfyUI-MiniMax-H3-Guide) `189★ · 2026-08-11` — 把提示词规范化成 H3 吃得准的形状。
- [Carasibana/ComfyUI-H3-FaceRefine](https://github.com/Carasibana/ComfyUI-H3-FaceRefine) `239★ · 2026-08-12` — 解决 H3 出片里小脸糊的问题：逐帧人脸跟踪、裁切、精修、贴回。
- [HM-RunningHub/ComfyUI_RH_MinMaxH3](https://github.com/HM-RunningHub/ComfyUI_RH_MinMaxH3) `119★ · 2026-08-05` — RunningHub 的 H3 节点包。
- [scottmudge/ComfyUI_MinimaxH3HybridLoader](https://github.com/scottmudge/ComfyUI_MinimaxH3HybridLoader) `125★ · 2026-08-11` — 混合加载器——把 fl2va 与 ref2va 两个模型的层/块混搭成一个。
...
- [Shrek3OnVH5/MiniMax-H3-NativeAudio-MusicVideo-Workflow](https://github.com/Shrek3OnVH5/MiniMax-H3-NativeAudio-MusicVideo-Workflow) `69★ · 2026-08-05` — 围绕 H3 原生音频搭的音乐视频工作流。

### Civitai 上的

- [H3 [LightX2V 6-8steps] collection](https://civitai.com/models/579280) *(Workflows)* `29k↓` — 下载量最高的 H3 工作流合集。
- [MiniMax H3 INT8/INT4 ConvRot](https://civitai.com/models/2830065) *(Checkpoint)* `18.2k↓` — 打包给 ComfyUI 的 ConvRot 检查点。
- [Lonecat's Simple Workflows](https://civitai.com/models/2600919) *(Workflows)* `14.3k↓` — 刻意做简的工作流。
- [MiniMax H3 lightx2v turbo accelerator](https://civitai.com/models/1063735) *(LORA)* `11.9k↓` — 以 LoRA 形式直接换入的 Turbo 加速。
- [MiniMax H3: EZ Turbo / RTX Upscale / LTX Refine](https://civitai.com/models/2831976) *(Workflows)* `10.3k↓` — Turbo 加超分与精修环节。
- [T2V / I2V / REF2V Advanced Filmmaking](https://civitai.com/models/2834514) *(Workflows)* `11.3k↓` — 一套影视流程覆盖三种输入模式。
- [MiniMax-H3 Multishot Seamless Chain](https://civitai.com/models/2833322) *(Workflows)* `5.9k↓` — 多镜头无缝串联生成。
- [Ultra Fastest Workflow (6GB VRAM / 16GB RAM)](https://civitai.com/models/2835250) *(Workflows)* `4.7k↓` — 真能跑起来的低配方案。
- [SageAttention four-mode workflow](https://civitai.com/models/2831550) *(ComfyWorkflows)* `4.2k↓` — SageAttention 四种模式并列对比。
- [4 STEPS TURBO AIO](https://civitai.com/models/2838258) *(Workflows)* `3.3k↓` — 4 步一体化配置。
- [INT4 ConvRot (12GB VRAM)](https://civitai.com/models/2830162) *(Checkpoint)* `2.7k↓` — 把 H3 塞进 12GB 显存。
- [SEEDVR2 upscaler + Ollama prompt helper](https://civitai.com/models/2836319) *(Workflows)* `2.9k↓` — 超分与本地提示词助手合在一张图里。
...
- [wildminder/awesome-minimax-H3](https://github.com/wildminder/awesome-minimax-H3) `267★ · 2026-08-17` — 在权重、量化与节点清单上做得极细——需要文件级细节时该看它。
- [AtlasCloudAI/awesome-minimax-h3-prompts](https://github.com/AtlasCloudAI/awesome-minimax-h3-prompts) `19★ · 2026-08-17` — 本清单的姊妹仓：官方案例 H3 提示词，每条附成片预览，20 语言。
...
- **每条链接都能打开。** 全清单已于 2026-08-18 用 GitHub / Hugging Face / Civitai 的 API 重新核验。已转私有、404、或无法程序化验证的条目一律剔除，不凭信任沿用。
